...
(tcc.overrideArgs { stage1env = stage0env;}).override (final: prev: with final;
{
  ...
  buildPhase = ''
    ...
    ./tcc -c -D HAVE_CONFIG_H=1 -I ${incdir} -I ${incdir}/linux/x86 -o crt1.o ${MES_PREFIX}/lib/linux/x86-mes-gcc/crt1.c
    ./tcc -c -D HAVE_CONFIG_H=1 -I ${incdir} -I ${incdir}/linux/x86 -o crtn.o ${MES_PREFIX}/lib/linux/x86-mes-gcc/crtn.c
